...
class editbp extends StatefulWidget {
  const editbp({super.key});

  @override
  State<editbp> createState() => _EditprofState();
}

class _EditprofState extends State<editbp> {
  String? a;
  String? lid;
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              TextFormField(decoration: InputDecoration(labelText: 'IMEI',hintText: 'enter IMEI number'),controller: imei,),
  ...
  Future<void> profiledetails() async{
    ...
    final res = await http.post(Uri.parse('$ipstr/myapp/editbp/'), body: {
      'bid': bid,
    });
  ...
  Future<void> Send_data() async{
    ...
    final uri=Uri.parse('$ipstr/myapp/editbp_post/');
